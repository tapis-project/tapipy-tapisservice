{
  description = "tapipy-tapisservice";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        tapisWelcome = pkgs.writeScriptBin "welcome" ''
          #!${pkgs.bash}/bin/bash
          echo -e "Entering tapipy-tapisservice development environment..."
          ...
          ==========================
            ...
            - make test: Run tests (in Docker) (must place password in config-dev-develop.json)
      ...
      in {
        devShells = {
          ...
          help = pkgs.mkShell {
            packages = commonPackages;
            shellHook = ''
              echo "Entering tapipy-tapisservice nix shell..."
